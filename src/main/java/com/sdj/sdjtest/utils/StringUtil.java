...
public class StringUtil {
    ...
    public String changeImage2String(String path){
        BufferedImage bufferedImage = null;
        try {
            bufferedImage = ImageIO.read(getClass().getClassLoader().getResourceAsStream(path));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return changeImage2String(bufferedImage);
    }
